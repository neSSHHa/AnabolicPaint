...
class ResizableCanvasApp:
    ...
    def end_straight_line(self, event):
        ...
        # Store the drawn object attributes
    ...
    def paste_selection(self):
        if self.serialized_selection:
            ...
            # Create an image item on the canvas and store it
    ...
    def zoom_canvas(self, central_point, zoom_factor):
       ...
       # Update item positions based on the current zoom factor
    ...
    def update_canvas(self):
        ...
        self.canvas.create_image(0, 0, image=image, anchor="nw")  # Anchor at top-left (NW)
